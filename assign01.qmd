...
This website is creating using RStudio Quarto. The zephyr theme is used for a professional look. The navigation bar includes github and email links connecting to the my content in different areas.
There are multiple tabs that show the different areas of my work including my CV, assignments, current research, and teaching experiences. 
The front home page gives a short description of my research interests and my academic standing. 
To build the website, one must...
...
Consistently update your work when new .qmd files are created and add them to the main .yml document. 
